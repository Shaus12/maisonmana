...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <svg
        viewBox="0 0 24 24"
        className="h-5 w-5 fill-current text-brass transition-transform group-hover:rotate-12 duration-300"
      ...
      <span className="text-[0.8125rem] tracking-[0.1em] uppercase font-bold display-he text-brass">
        {locale === "he" ? "התכתבות פרטית" : "Private Inquiry"}
      </span>
    </a>
  );
}
